            ...
            Row(
              children: [
                const Text(
                  "Welcome Back!",
                  style: TextStyle(
                      color: Color.fromARGB(255, 138, 136, 136), fontSize: 30),
                ),
                const SizedBox(
                  width: 80,
                ),
                IconButton(
                  ...
                  iconSize: 40,
                  color: const Color.fromARGB(221, 0, 0, 128),
                )
              ],
            ),
            const SizedBox(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  Container(
                    ...
                    padding:const EdgeInsets.all(20),
                    decoration: BoxDecoration(
                      color:const Color.fromARGB(100, 178, 217, 220),
                  ...
                  Container(
                    ...
                    padding:const EdgeInsets.all(20),
                    decoration: BoxDecoration(
                      color: const Color.fromARGB(100, 224, 202, 217),
                      borderRadius: BorderRadius.circular(60),
                    ),
                    child: Row(
                      children: [
                  ...
                  Container(
                    ...
                    padding: const EdgeInsets.all(20),
                    decoration: BoxDecoration(
                      color: const Color.fromARGB(100, 254, 241, 167),
                      borderRadius: BorderRadius.circular(60),
                    ),
                    child: Row(
                      children: [
